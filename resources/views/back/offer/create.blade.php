...
@section('title', 'Offer Create Page')
@section('content')
                ...
                @endif
                        <form action="{{ route('admin.offers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Enter Offer Name">
                            </div>
                    ...
                    <div class="form-group" id="offer_option">
                        <label>Type</label>
                        <select style="width: 100%" name="type">
                            ...
                            <option value="5">about us image</option>
                        </select>
                   </div>

                   <div class="form-group offer_value" id="offer_value">
                        <label for="name">Offer Value</label>
                        <input type="text" class="form-control" name="offer_value" placeholder="Enter Offer Value">
                    </div>
...
<script>
    $(document).ready(function(){
      ...
      // alert($('#offer_value :selected').text());
      $("body").on('change', function(){
        if($('#offer_option :selected').val() == '2'){
          $('.offer_value').show();  
        }else{
           $('.offer_value').hide(); 
        }
