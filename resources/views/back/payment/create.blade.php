...
@section('title', 'Payment Create Page')
@section('content')
    ...
    <div class="row">
        <div class=" offset-sm-3 col-md-6">
            ...
            <div class="card-title">
                <h3 class="box-title m-b-0">Add New Payment</h3>
            </div>
            <div class="card card-body">

                <p class="text-muted m-b-30 font-13"> new Payment </p>
                <div class="row">
                ...
                @endif
                        <form action="{{ route('admin.payments.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Payment Name" value="{{old('name')}}" >
                            </div>
