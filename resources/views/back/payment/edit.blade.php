...
@section('title', 'Payment Edit Page')
@section('content')
    ...
    <div class="row">
        <div class=" offset-sm-3 col-md-6">
            ...
            <div class="card-title">
                <h3 class="box-title m-b-0"> Edit Payment</h3>
            </div>
            <div class="card card-body">

                <p class="text-muted m-b-30 font-13"> Payment </p>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form action="{{ route('admin.payments.update',$payment->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="payment" value="{{ $payment->name }}">
                            </div>
