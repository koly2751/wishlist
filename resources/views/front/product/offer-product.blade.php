...
<main class="main">
    ...
    <div class="banner banner-cat" style="background-image:url({{ asset('/backend/images/allbanner/single_banner.jpg') }});" >
        <div class="banner-content container">
           
            <h1 class="banner-title" style="color:whitesmoke">
               oo
            </h1>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb mt-0">
                ...
                <li class="breadcrumb-item"><a href="{{route('alloffer')}}">Offer</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{$offersingle->title}}</li>
            </ol>
        </div><!-- End .container -->
    </nav>
        ...
        <div class="row products-body">
                                ...
                                <div class="price-box">
                                    <span class="product-price">
                                      @if($value->offer)
                                        ...
                                        {{round($value->price - ($value->price*((App\Offer::find($value->offer)->value)/100)))}} / 
                                     <small>
                                         <del>
                                            {{$value->price}} 
                                        </del>
           ...
           <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                <div class="sidebar-wrapper">
                    ...
                    <div class="widget">
                        <h3 class="widget-title">
                            <a data-toggle="collapse" href="#widget-body-4" role="button" aria-expanded="true" aria-controls="widget-body-4">Offers</a>
                        </h3>
                        ...
                        <div class="collapse show" id="widget-body-4">
                            <div class="widget-body">
                                <ul class="cat-list">
                                    ...
                                    <li><a href="{{route('offer',$offr->id)}}">{{$offr->title}}</a></li>
                                    @endforeach
                                </ul>
                            </div><!-- End .widget-body -->
                        </div><!-- End .collapse -->
