...
<main class="main">
    ...
    <div class="recipient-category ">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 title mb-4 text-center">Who is the ocassion?</h2>
                </div>
            </div>
            <div class="row">
        ...
        <nav class="toolbox horizontal-filter">
           ...
           <!--  <div class="toolbox-item toolbox-sort">
            ...
            <div class="toolbox-item ">
                ...
                <div class="layout-modes" style="margin-left: 870px;">
                    <a href="{{route('usercategories.index')}}" class="layout-btn btn-grid active" title="Grid">
